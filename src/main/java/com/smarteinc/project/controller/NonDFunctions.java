...
public class NonDFunctions {
    ...
    public void getemployee() {
        ...
        while (true) {
            ...
            System.out.println("  3.find employees having CTC greater than 2 lakh. and less than 5 lakh");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    Map<String, List<Employee1>> employeeListByDepartment1 =
                            employeeList.stream().filter(e -> e.getCity().equalsIgnoreCase("mumbai") && e.getSalary() > 200000 && e.getSalary() < 500000).collect(Collectors.groupingBy(Employee1::getDepartment));
